...
import data_loader_general as dl
import train_general as tt
import os
from tensorboardX import SummaryWriter
writer = SummaryWriter('/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/log')
...
train=dl.data_loader(dic="/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/data_general/train",state="prepared")
val=dl.data_loader(dic="/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/data_general/val",state="prepared")
...
steps=100
wt1=open("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/traj/trloss","w+")
wt2=open("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/traj/valoss","w+")
...
for _ in range(steps+1):
    ...
    writer.add_scalar('general_train/loss', loss.detach().cpu().numpy(), _)
    ...
    with torch.no_grad():
        ...
        writer.add_scalar('general_val/loss', loss.detach().cpu().numpy(), _)
    ...
    if _%10 ==0:
        ...
        for sgrna,  eff ,typ  in trloader:
            ...
            torch.cuda.empty_cache()
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/out/efftr"+"_"+str(_),effsave)
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/out/pretr"+"_"+str(_),presave)
        ...
        for sgrna, eff ,typ  in trloader:
            ...
            if len(presave)==0 :
                ...
                effsave=np.concatenate((effsave,eff))
            torch.cuda.empty_cache()
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/out/effval"+"_"+str(_),effsave)
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/out/preval"+"_"+str(_),presave)

        torch.save(net,"/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/General/output/model/"+str(_)+".pt")
        writer.close()
