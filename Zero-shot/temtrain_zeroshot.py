...
writer = SummaryWriter('/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/log')
...
train=dl.data_loader(dic="/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/data_zeroshot/train",state="prepared")
val=dl.data_loader(dic="/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/data_zeroshot/val",state="prepared")
...
steps=100
wt1=open("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/traj/trloss","w+")
wt2=open("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/traj/valoss","w+")
...
for _ in range(steps+1):
    ...
    writer.add_scalar('zeroshot_train/loss', loss.detach().cpu().numpy(), _)
    ...
    with torch.no_grad():
        ...
        writer.add_scalar('zeroshot_val/loss', loss.detach().cpu().numpy(), _)
    ...
    if _%10 ==0:
        ...
        for sgrna,  eff ,typ  in trloader:
            ...
            torch.cuda.empty_cache()
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/out/efftr"+"_"+str(_),effsave)
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/out/pretr"+"_"+str(_),presave)
        ...
        for sgrna, eff ,typ  in trloader:
            ...
            if len(presave)==0 :
                ...
                effsave=np.concatenate((effsave,eff))
            torch.cuda.empty_cache()
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/out/effval"+"_"+str(_),effsave)
        np.save("/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/out/preval"+"_"+str(_),presave)

        torch.save(net,"/public/home/hpc234711034/Project/Cas9-sgRNA/sgRNA_Protein/other/PLM-CRISPR/Zero-shot/output/model/"+str(_)+".pt")
        writer.close()
